...
Feature: Fastly Integration
  ...
  Scenario: Add Fastly account returns "Bad Request" response
    ...
    And body with value {"data": {"attributes": {"api_key": "ABCDEFG123", "name": "test-name", "services": [{"tags": ["myTag", "myTag2:myValue"]}]}, "id": "abc123", "type": "fastly-accounts"}}
  ...
  @generated @skip @team:Datadog/web-integrations
  Scenario: Add Fastly account returns "The schema representation of a Fastly account." response
    Given new "CreateFastlyAccount" request
    And body with value {"data": {"attributes": {"api_key": "ABCDEFG123", "name": "test-name", "services": [{"tags": ["myTag", "myTag2:myValue"]}]}, "id": "abc123", "type": "fastly-accounts"}}
    When the request is sent
    Then the response status is 201 The schema representation of a Fastly account.
  ...
  @generated @skip @team:Datadog/web-integrations
  Scenario: Add Fastly service returns "The schema representation of a Fastly service." response
    Given new "CreateFastlyService" request
    And request contains "account_id" parameter from "REPLACE.ME"
    And body with value {"data": {"attributes": {"tags": ["myTag", "myTag2:myValue"]}, "id": "abc123", "type": "fastly-services"}}
    When the request is sent
    Then the response status is 201 The schema representation of a Fastly service.
  ...
  @generated @skip @team:Datadog/web-integrations
  Scenario: Get Fastly account returns "The schema representation of a Fastly account." response
    Given new "GetFastlyAccount" request
    And request contains "account_id" parameter from "REPLACE.ME"
    When the request is sent
    Then the response status is 200 The schema representation of a Fastly account.
  ...
  @generated @skip @team:Datadog/web-integrations
  Scenario: Get Fastly service returns "The schema representation of a Fastly service." response
    Given new "GetFastlyService" request
    And request contains "account_id" parameter from "REPLACE.ME"
    And request contains "service_id" parameter from "REPLACE.ME"
    When the request is sent
    Then the response status is 200 The schema representation of a Fastly service.
  ...
  @generated @skip @team:Datadog/web-integrations
  Scenario: List Fastly accounts returns "The schema representation of a Fastly account." response
    Given new "ListFastlyAccounts" request
    When the request is sent
    Then the response status is 200 The schema representation of a Fastly account.
  ...
  @generated @skip @team:Datadog/web-integrations
  Scenario: List Fastly services returns "The schema representation of a Fastly service." response
    Given new "ListFastlyServices" request
    And request contains "account_id" parameter from "REPLACE.ME"
    When the request is sent
    Then the response status is 200 The schema representation of a Fastly service.
  ...
  Scenario: Update Fastly account returns "Bad Request" response
    ...
    And request contains "account_id" parameter from "REPLACE.ME"
    And body with value {"data": {"attributes": {"api_key": "ABCDEFG123", "services": [{"tags": ["myTag", "myTag2:myValue"]}]}}}
    When the request is sent
    Then the response status is 400 Bad Request
  ...
  Scenario: Update Fastly account returns "OK" response
    ...
    And request contains "account_id" parameter from "fastly_account.data.id"
    And body with value {"data": {"attributes": {"api_key": "update-secret", "services": []}, "type": "fastly-accounts"}}
    When the request is sent
    Then the response status is 200 OK
    And the response "data.attributes.services" is equal to []
    And the response "data.attributes.name" is equal to "{{fastly_account.data.attributes.name }}"

  @generated @skip @team:Datadog/web-integrations
  Scenario: Update Fastly account returns "The schema representation of a Fastly account." response
    Given new "UpdateFastlyAccount" request
    And request contains "account_id" parameter from "REPLACE.ME"
    And body with value {"data": {"attributes": {"api_key": "ABCDEFG123", "services": [{"tags": ["myTag", "myTag2:myValue"]}]}}}
    When the request is sent
  ...
  @generated @skip @team:Datadog/web-integrations
  Scenario: Update Fastly service returns "The schema representation of a Fastly service." response
    Given new "UpdateFastlyService" request
    And request contains "account_id" parameter from "REPLACE.ME"
    And request contains "service_id" parameter from "REPLACE.ME"
    And body with value {"data": {"attributes": {"tags": ["myTag", "myTag2:myValue"]}, "id": "abc123", "type": "fastly-services"}}
