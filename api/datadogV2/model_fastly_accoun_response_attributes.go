...
func (o *FastlyAccounResponseAttributes) GetServices() []FastlyServiceRequestAttributes {
...
// and a boolean to check if the value has been set.
func (o *FastlyAccounResponseAttributes) GetServicesOk() (*[]FastlyServiceRequestAttributes, bool) {
	if o == nil || o.Services == nil {
		return nil, false
	}
...
func (o *FastlyAccounResponseAttributes) SetServices(v []FastlyServiceRequestAttributes) {
	o.Services = v
}
