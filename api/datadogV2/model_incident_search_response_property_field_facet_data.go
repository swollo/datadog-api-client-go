...
// IncidentSearchResponsePropertyFieldFacetData Facet data for incident property fields.
type IncidentSearchResponsePropertyFieldFacetData struct {
	...
	// Facet data for property field of an incident.
	Facets []IncidentSearchResponseFieldFacetData `json:"facets"`
	// Name of incident property field.
