...
func (o *FastlyAccountCreateRequestAttributes) GetServices() []FastlyServiceRequestAttributes {
...
// and a boolean to check if the value has been set.
func (o *FastlyAccountCreateRequestAttributes) GetServicesOk() (*[]FastlyServiceRequestAttributes, bool) {
	if o == nil || o.Services == nil {
		return nil, false
	}
...
func (o *FastlyAccountCreateRequestAttributes) SetServices(v []FastlyServiceRequestAttributes) {
	o.Services = v
}
