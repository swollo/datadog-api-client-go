...
type FastlyServiceResponse struct {
	...
	Data *FastlyServiceRequestData `json:"data,omitempty"`
...
func (o *FastlyServiceResponse) GetData() FastlyServiceRequestData {
	if o == nil || o.Data == nil {
		var ret FastlyServiceRequestData
		return ret
	}
	return *o.Data
}
...
func (o *FastlyServiceResponse) GetDataOk() (*FastlyServiceRequestData, bool) {
	if o == nil || o.Data == nil {
		return nil, false
	}
	return o.Data, true
...
// SetData gets a reference to the given FastlyServiceRequestData and assigns it to the Data field.
func (o *FastlyServiceResponse) SetData(v FastlyServiceRequestData) {
	o.Data = &v
}
