...
func NewFastlyAccountCreateRequestData(attributes FastlyAccountCreateRequestAttributes, id string, typeVar FastlyAccountType) *FastlyAccountCreateRequestData {
...
func (o *FastlyAccountCreateRequestData) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *FastlyAccountCreateRequestData) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *FastlyAccountCreateRequestData) SetId(v string) {
	o.Id = v
}
