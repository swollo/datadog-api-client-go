// Update Fastly service returns "The schema representation of a Fastly service." response
...
func main() {
	body := datadogV2.FastlyServiceRequest{
		Data: datadogV2.FastlyServiceRequestData{
			Attributes: &datadogV2.FastlyServiceRequestAttributes{
				Tags: []string{
					"myTag",
					"myTag2:myValue",
				},
